...
<body class="antialiased">
    ...
    <div class="relative flex items-top justify-center sm:items-center py-4 sm:pt-0">
        ...
        @if (Route::has('login'))
        <div class="hidden fixed top-2 right-1 space-x-3 px-6 py-4 sm:block">
            @auth
            <a href="{{ url('/dashboard') }}" class=" text-m text-gray-700 dark:text-gray-500 hover:underline">Dashboard</a>
            <a href="#" class=" text-m text-gray-700 dark:text-gray-500 hover:underline"> Home </a>
            <a href="#" class=" text-m text-gray-700 dark:text-gray-500 hover:underline"> About Us </a>
            <a href="#subscribe" class=" text-m text-gray-700 dark:text-gray-500 hover:underline"> Subscribe </a>
            @else
    ...
    <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6">
        ...
        <div class="lg:grid lg:grid-cols-6">
            ...
            <x-old-post :post="$post" class="{{$loop -> iteration < 3 ? 'col-span-3' : 'col-span-2'}}" />
            @endforeach
        </div>
